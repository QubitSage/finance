          ...
          <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4">
                ...
                <div className="relative w-full max-w-sm">
                        <div className="text-center mb-10">
                                  ...
                                  <h1 className="font-display text-4xl font-semibold text-stone-800 italic">Casal App</h1>h1>
                                  <p className="text-sm text-stone-400 mt-2 font-sans">Tudo do casal, num só lugar.</p>p>
                        </div>div>
                        <div className="card">
                            ...
                            <button key={m} onClick={() => setMode(m)}
                                ...
                                {m === 'login' ? 'Entrar' : 'Criar conta'}
                                  ...
                                  <form onSubmit={handle} className="flex flex-col gap-4">
                                              <div>
                                                            <label className="label">Usuário</label>label>
                                      ...
                                      {error && (
                            <p className="text-xs text-blush-600 bg-blush-50 border border-blush-100 px-3 py-2 rounded-lg">{error}</p>p>
                                              )}
                                      {success && (
                            <p className="text-xs text-sage-600 bg-sage-50 border border-sage-100 px-3 py-2 rounded-lg">{success}</p>p>
                                              )}
